...
function CardSkills({ technologies, title }) {
  return (
    <div className="max-w-lg border-2 border-coolGray dark:border-0 dark:bg-[#323453] rounded-2xl py-6 px-8">
      <p className="text-2xl font-medium text-center text-primary dark:text-white">
        {title}
      </p>
